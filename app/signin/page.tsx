                ...
                <form>
                  ...
                  <div className="mb-6">
                    <button
                      ...
                      disabled={loading}
                      className="hover:shadow-signUp flex w-full items-center justify-center rounded-md bg-blue-600 px-9 py-4 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-80"
                    >
                      {loading ? "..." : "Entre"}
                    </button>
                  </div>
